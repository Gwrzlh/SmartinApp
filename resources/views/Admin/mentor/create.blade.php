        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100">
                ...
                <div class="px-8 py-10">
                    <form action="{{ route('admin.mentor.store') }}" method="POST" class="space-y-6" id="mentorForm"
                        onsubmit="handleFormSubmit(event)">
                        @csrf
                        @if ($errors->any())
                            <div id="errorContainer"
                                class="p-4 mb-4 text-sm text-red-800 rounded-xl bg-red-50 border border-red-100 hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label for="mentor_name"
                                    class="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Nama Langkap
                                    Mentor</label>
                        ...
                        <div class="flex flex-col md:flex-row md:items-end gap-6 pt-4">
                            ...
                            <div
                                class="flex items-center pb-3 px-4 h-[52px] bg-gray-50/50 border-2 border-gray-100 rounded-xl group hover:bg-cyan-50/50 hover:border-cyan-100 transition-all">
                                <input type="checkbox" name="isActive" id="isActive"
                                    class="h-5 w-5 text-cyan-600 border-gray-300 rounded-lg focus:ring-cyan-500 cursor-pointer">
                                <label for="isActive"
                                    class="ml-3 text-sm font-semibold text-gray-600 cursor-pointer group-hover:text-cyan-700">Status
                                    Mentor</label>
                            </div>
                        </div>
                        <div class="space-y-3 pt-4 border-t border-gray-50">
                            ...
                            <div class="relative">
                                <select id="subjectSelector"
                                    ...
                                    <option value="" disabled selected>-- Klik untuk memilih keahlian mentor --
                                    </option>
