    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100">
            ...
            <div class="px-8 py-10">
                <form action="{{ route('admin.bundling.update', $bundling->id) }}" method="POST" id="bundlingForm" onsubmit="handleFormSubmit(event)">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="p-8 space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="bundling_name" id="bundling_name" 
                                    ...
                                    placeholder="Contoh: Paket Intensif UN" required value="{{ old('bundling_name', $bundling->bundling_name) }}">
                            </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="bundling_price" id="bundling_price" oninput="formatRupiah(this)"
                                            ...
                                            placeholder="1.000.000" required value="{{ old('bundling_price', number_format($bundling->bundling_price,0,',','.') ) }}">
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center h-[52px]">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="isActive" id="isActive" class="sr-only peer" {{ old('isActive', $bundling->is_active) ? 'checked' : '' }}>
